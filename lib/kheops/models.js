...
kh.loadModelFromUrl = function loadModelFromUrl( url, desc, onLoadHandler) {

    var getOnLoadObjectHandler = function getOnLoadObjectHandler( url, desc, onLoadHandler) {
    ...
    req.onreadystatechange = getOnLoadObjectHandler( url, desc, onLoadHandler);
...
kh.primitive.model = {
     ...
     'create': function create( scene, properties, desc, onCreateHandler) {
    	...
    	kh.loadModelFromUrl( desc.src, desc, getOnLoadModelHandler( scene, properties, onCreateHandler));
     },
