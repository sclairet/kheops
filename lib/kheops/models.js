                    ...
                    if ('colorsMap' in model.desc) {
                        model.materialNames.forEach(function(name) {
                            ...
                            if (group.indexes.length > 0) {
                                var material = (group.name in model.desc.materials) ? model.desc.materials[group.name] : kh.materials.desc.default;
                                material.color = (group.name in model.desc.colorsMap) ? model.desc.colorsMap[group.name] : [0.8, 0.8,  08, 1.0];
